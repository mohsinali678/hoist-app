...
function Questionare () {
    ...
    <section>
        ...
        <form onSubmit={handleSubmit}> 
            ...
            <br></br>
            <input type="checkbox" id="water-intake" name="water-intake" onClick={handleCheckbox} value={questions.waterIntake}/>
            ...
            <br></br>
            <input type="checkbox" id="screen-time" name="screen-time" onClick={handleCheckbox} value={questions.screenTime}/>
            <label for="screen-time">Screen time</label>
            <br></br>
            <input type="checkbox" id="heart-rate" name="heart-rate" onClick={handleCheckbox} value={questions.heartRate}/>
            <label for="heart-rate">Heart rate</label>
            <br></br>
            <input type="checkbox" id="blood-oxygen" name="blood-oxygen" onClick={handleCheckbox} value={questions.bloodOxygen}/>
            <label for="blood-oxygen">Blood oxygen level</label>
            <br></br>
            <input type="checkbox" id="sleep-amount" name="sleep-amount" onClick={handleCheckbox} value={questions.sleepAmount}/>
